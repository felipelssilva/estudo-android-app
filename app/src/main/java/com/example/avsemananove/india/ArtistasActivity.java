...
import com.example.avsemananove.india.artistas.*;
...
public class ArtistasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("País > Índia > Artistas");
        setContentView(R.layout.activity_india_artistas);

        ListView lista = (ListView) findViewById(R.id.lv_india_artistas);
