package com.example.avsemananove.russia;
...
import com.example.avsemananove.russia.artistas.*;
...
public class ArtistasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("País > Rússia > Artistas");
        setContentView(R.layout.activity_russia_artistas);

        ListView lista = (ListView) findViewById(R.id.lv_russia_artistas);
