...
import com.example.avsemananove.novazelandia.artistas.*;
...
public class ArtistasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("País > Nova Zelândia > Artistas");
        setContentView(R.layout.activity_nova_zelandia_artistas);

        ListView lista = (ListView) findViewById(R.id.lv_novazelandia_artistas);
