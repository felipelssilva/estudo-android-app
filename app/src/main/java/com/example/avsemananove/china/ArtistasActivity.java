...
import com.example.avsemananove.china.artistas.*;
...
public class ArtistasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("País > China > Artistas");
        setContentView(R.layout.activity_china_artistas);

        ListView lista = (ListView) findViewById(R.id.lv_china_artistas);
