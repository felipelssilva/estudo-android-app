...
import com.example.avsemananove.japao.artistas.*;
...
public class ArtistasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("País > Japão > Artistas");
        setContentView(R.layout.activity_japao_artistas);

        ListView lista = (ListView) findViewById(R.id.lv_japao_artistas);
