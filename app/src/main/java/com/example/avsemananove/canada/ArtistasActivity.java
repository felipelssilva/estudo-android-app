...
import com.example.avsemananove.canada.artistas.*;
...
public class ArtistasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("País > Canadá > Artistas");
        setContentView(R.layout.activity_canada_artistas);

        ListView lista = (ListView) findViewById(R.id.lv_canada_artistas);
